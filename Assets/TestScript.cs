...
public class TestScript : MonoBehaviour 
{
	...
	void Start() {
		Flurry.Instance.StartSession(_iosApiKey, _iosApiKey);
		Flurry.Instance.LogUserID("User");
		Flurry.Instance.LogEvent("Event", new Dictionary<string, string> {{ "Platform", Application.platform.ToString() }});
	}
